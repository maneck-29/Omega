...
import { publicUrl } from "./media-url";
...
/*
 * URL shapes live in `media-url.ts`, which carries no AWS SDK import so the read
 * path can normalise a stored URL without pulling the S3 client into a render.
